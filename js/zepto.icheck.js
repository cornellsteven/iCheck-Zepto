/*
  iCheck v0.7, https://github.com/cornellsteven/iCheck (Original: http://git.io/uhUPMA)
  ===================================
		    ...
		    if (/^(check|uncheck|disable|enable|update|destroy)$/.test(options)) {
		      return this.each(function() {
		        ...
		        var ua = navigator.userAgent,
		          ...
		          handle = /^(checkbox|radio)$/.test(settings.handle) ? '[type="' + settings.handle + '"]' : '[type="checkbox"], [type="radio"]',
